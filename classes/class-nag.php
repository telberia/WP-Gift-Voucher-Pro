...
class WPGIFT_Nag {
	...
	public function display_admin_notice() {
		...
		printf( __( "You've been using <b>Gift Voucher</b> for some time now, could you please give it a review at wordpress.org? <br /><br /> <a href='%s' target='_blank'>Yes, take me there!</a> I've already done this!</a><br/><br/>" ), 'https://wordpress.org/support/plugin/gift-voucher/', $query_string );
		echo "</p></div>";
