jQuery(document).ready(function($) {
    ...
    $('#paynowbtn').click(function() {
        ...
        if ($shipping.val() == 'shipping_as_email') {
            ...
            $datastring = $url + $urlstring + '&shipping=' + wpgv_b64EncodeUnicode($shipping.val()) + '&shipping_email=' + wpgv_b64EncodeUnicode($shipping_email.val()) + '&receipt_email=' + wpgv_b64EncodeUnicode($receipt_email.val()) + '&paymentmethod=' + wpgv_b64EncodeUnicode($payemnt_gateway.val()) + '&seller_company_name=' + wpgv_b64EncodeUnicode($company_name.val()) + '&seller_addr_line1=' + wpgv_b64EncodeUnicode($address_line1.val()) + '&seller_addr_line2=' + wpgv_b64EncodeUnicode($address_line2.val()) + '&seller_addr_line3=' + wpgv_b64EncodeUnicode($address_line3.val()) + '&seller_addr_line4=' + wpgv_b64EncodeUnicode($address_line4.val());
            ...
            if (!($receipt_email.val() && wpgv_validateEmail($receipt_email.val()))) {
                ...
                $receipt_email.closest('.wpgv-form-fields').find('.error').hide();
                $company_name.closest('.wpgv-form-fields').find('.error').hide();
                $receipt_email.closest('.wpgv-form-fields').find('.eqlerror').hide();
            }
    ...
    function wpgv_formdata() {
        ...
        $codecard = $('.codeFormRight .codeCard').val();

        return '&catid=' + $catid + '&itemid=' + $itemid + '&style=' + $style + '&totalprice=' + $totalprice + '&buyingfor=' + $buyingfor + '&yourname=' + $yourname + '&recipientname=' + $recipientname + '&recipientmessage=' + $recipientmessage + '&couponcode=' + $codecard;
    }
