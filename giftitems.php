...
function wpgv_giftitems_shortcode ($atts = '') 
{
    ...
    $wpgv_additional_charges_text = get_option('wpgv_additional_charges_text_item') ? get_option('wpgv_additional_charges_text_item') : 'Additional Website Charges';
    ...
    if($shortcode_attr['item_cat_id'] != 0){
        $wpgv_voucher_categories = get_term($shortcode_attr['item_cat_id']);
        $image_id = get_term_meta( $wpgv_voucher_categories->term_id, 'wpgv-voucher-category-image-id', true );
    }
    else{
        ...
        $wpgv_voucher_categories = get_categories(array(
    ...
    if($shortcode_attr['item_id'] == 0 && $shortcode_attr['item_cat_id'] == 0)
    {
        foreach ($wpgv_voucher_categories as $category) {
            $html .= '<div class="wpgv-according-category" id="itemcat'.$category->term_id.'">
                ...
                $string = '';
                if($wpgv_item_sort_by == 'high-to-low'){
                    // High to Low
                    $string .= "DESC";
                }
                else if($wpgv_item_sort_by == 'low-to-high'){
                    // Low to High
                    $string .= "ASC";
                }
                else if($wpgv_item_sort_by == 'name'){
                    // Low to High
                    $string .= "ASC";
                }
                ...
                foreach ($items as $item) {
                    ...
                    $html .= '<div class="wpgv-item">
                            ...
                            <div class="wpgv-buy"><button type="button" data-item-id="'.$item_id.'" data-cat-id="'.$category->term_id.'" data-item-price="'.$subprice.'" data-item-price-pdf="'.$subprice.'">'.__('Buy', 'gift-voucher').'</button></div>
                        </div>';
                }
                $html .= '</div>';
    ...
    $html .= '<div id="wpgv-giftitems-step3" class="wpgv-items-wrap">
            ...
            if($invoice_options->is_invoice_active == 1){
                $html .= '<div class="wpgv-form-fields" id="wpgv-company_name">
                    ...
                    <input type="email" name="company_name" id="company_name" class="form-field">
                </div>
                <div class="wpgv-form-fields" id="wpgv-address_line1">
                    <label>'.__('Address Line 1', 'gift-voucher' ).'</label>
                    <input type="email" name="address_line1" id="address_line1" class="form-field">
                </div>
                <div class="wpgv-form-fields" id="wpgv-address_line2">
                    <label>'.__('Address Line 2', 'gift-voucher' ).'</label>
                    <input type="email" name="address_line2" id="address_line2" class="form-field">
                </div>
                <div class="wpgv-form-fields" id="wpgv-address_line3">
                    <label>'.__('Address Line 3', 'gift-voucher' ).'</label>
                    <input type="email" name="address_line3" id="address_line3" class="form-field">
                </div>
                <div class="wpgv-form-fields" id="wpgv-address_line4">
                    <label>'.__('Address Line 4', 'gift-voucher' ).'</label>
                    <input type="email" name="address_line4" id="address_line4" class="form-field">
                </div>';
            }


    $html .= '<div class="wpgv-form-fields" id="wpgv-post_name">
                ...
                $html .= '</div>
                <div class="wpgv-form-fields paymentcount'.$paymentCount.'" id="wpgv_payment_gateway">
                ...
                <div class="cardDiv">
                    <div class="voucherBottomDiv">
                        ...
                        <div class="uk-form-row">
                            ...
                            <div class="codeFormRight">
                                <label>'.__('Coupon Code', 'gift-voucher' ).'</label>
                                <input type="text" name="codeCard" class="codeCard" readonly value="">
                            </div>
                            <div class="clearfix"></div>
                            <div class="voucherSiteInfo"><a href="'.$setting_options->pdf_footer_url .'">'.$setting_options->pdf_footer_url.'</a> | <a href="mailto:'.$setting_options->pdf_footer_email.'">'.$setting_options->pdf_footer_email.'</a></div>
                            <div class="termsCard">* '.$wpgv_leftside_notice.'</div>
